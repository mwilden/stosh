...
namespace {
  ...
  void load_defaults(Options& o) {
    ...
    o["Play Style"] = Option("Active", COMBO);
    o["Play Style"].comboValues.push_back("Passive");
    o["Play Style"].comboValues.push_back("Solid");
    o["Play Style"].comboValues.push_back("Active");
    o["Play Style"].comboValues.push_back("Aggressive");
    o["Play Style"].comboValues.push_back("Suicidal");
    o["Play Style"].comboValues.push_back("Random");
    ...
    o["UCI_Elo"] = Option(2450, 800, 2450);
...
void set_option_value(const string& name, const string& value) {
  ...
  // by terminal window. So let's check the bounds anyway.
...
namespace {
  ...
  void update_play_style() {
    std::string playStyle = get_option_value_string("Play Style");
    std::cout << "New style: " << playStyle << std::endl;
    if (playStyle == "Passive") {
      set_option_value("Mobility (Middle Game)", "40");
      set_option_value("Mobility (Endgame)", "40");
      set_option_value("Space", "0");
      set_option_value("Cowardice", "150");
      set_option_value("Aggressiveness", "40");
    }
    else if (playStyle == "Solid") {
      set_option_value("Mobility (Middle Game)", "80");
      set_option_value("Mobility (Endgame)", "80");
      set_option_value("Space", "70");
      set_option_value("Cowardice", "150");
      set_option_value("Aggressiveness", "80");
    }
    else if (playStyle == "Active") {
      set_option_value("Mobility (Middle Game)", "100");
      set_option_value("Mobility (Endgame)", "100");
      set_option_value("Space", "100");
      set_option_value("Cowardice", "100");
      set_option_value("Aggressiveness", "100");
    }
    else if (playStyle == "Aggressive") {
      set_option_value("Mobility (Middle Game)", "120");
      set_option_value("Mobility (Endgame)", "120");
      set_option_value("Space", "120");
      set_option_value("Cowardice", "100");
      set_option_value("Aggressiveness", "150");
    }
    else if (playStyle == "Suicidal") {
      set_option_value("Mobility (Middle Game)", "150");
      set_option_value("Mobility (Endgame)", "150");
      set_option_value("Space", "150");
      set_option_value("Cowardice", "80");
      set_option_value("Aggressiveness", "200");
    }
    else if (playStyle == "Random") {
      std::stringstream ss;
      ss << (genrand_int32() % 201);
      std::cout << "mg mobility: " << ss.str() << std::endl;
      set_option_value("Mobility (Middle Game)", ss.str());
      ss.clear(); ss.str("");
      ss << (genrand_int32() % 201);
      std::cout << "eg mobility: " << ss.str() << std::endl;
      set_option_value("Mobility (Endgame)", ss.str());
      ss.clear(); ss.str("");
      ss << (genrand_int32() % 201);
      std::cout << "space: " << ss.str() << std::endl;
      set_option_value("Space", ss.str());
      ss.clear(); ss.str("");
      ss << (genrand_int32() % 201);
      std::cout << "cow: " << ss.str() << std::endl;
      set_option_value("Cowardice", ss.str());
      ss.clear(); ss.str("");
      ss << (genrand_int32() % 201);
      std::cout << "agg: " << ss.str() << std::endl;
      set_option_value("Aggressiveness", ss.str());
    }
  }
